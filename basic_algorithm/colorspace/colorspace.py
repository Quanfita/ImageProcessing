...
def RGB2LAB(image):
    ...
    L = 116*((Y/Yn)**(1/3)*t + (1 - t)*((29/6)**2*(Y/Yn)+4/29)) - 16
    a = 500*(((X/Xn)**(1/3)*t + (1 - t)*((29/6)**2*(X/Xn)+4/29)) - ((Y/Yn)**(1/3)*t + (1 - t)*((29/6)**2*(Y/Yn)+4/29)))
    b = 200*(((Y/Yn)**(1/3)*t + (1 - t)*((29/6)**2*(Y/Yn)+4/29)) - ((Z/Zn)**(1/3)*t + (1 - t)*((29/6)**2*(Z/Zn)+4/29)))
